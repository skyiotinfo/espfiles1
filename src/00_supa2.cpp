...
// if (!sch1.active && sch1.state == 1 && nowUnix > sch1.stopUnix && digitalRead(MOTOR_PIN) == LOW) {
//   digitalWrite(MOTOR_PIN, HIGH);
//   updateTable(USER_TOKEN, 1);
// }
 
// if (!sch1.active && sch1.state == 0 && nowUnix > sch1.stopUnix && digitalRead(MOTOR_PIN) == HIGH) {
//   digitalWrite(MOTOR_PIN, LOW);
//   updateTable(USER_TOKEN, 0);
// }
 
// Clear app cancellation after schedule window passes
    // if (scheduleCancelledByApp && nowUnix > sch1.stopUnix) {
    //     scheduleCancelledByApp = false;
    //     Serial.println("App cancellation cleared for next schedule");
    // }
